...
function ensurePlottingGuideStyles() {
  ...
  style.textContent = `
    .plot-lab{font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;max-width:960px;margin:22px 0;background:var(--v2-bg-elevated);border:1px solid var(--v2-border);border-radius:14px;box-shadow:0 4px 14px rgba(15,23,42,.055);overflow:hidden;color:var(--v2-fg);}
    .plot-lab-header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 18px;border-bottom:1px solid var(--v2-border);background:var(--v2-bg-elevated);font-size:15px;font-weight:750;color:var(--v2-fg);}
    .plot-lab-subtitle{font-size:12px;color:var(--v2-fg-muted);font-weight:500;}
    ...
    .plot-lab-btn{width:100%;border:1px solid #dbe3ef;background:var(--v2-bg-elevated);color:var(--v2-fg-secondary);border-radius:10px;padding:10px 12px;text-align:left;font-size:13px;line-height:1.35;cursor:pointer;transition:all .15s;}
    .plot-lab-btn:hover{background:var(--v2-bg-subtle);transform:translateY(-1px);}
    .plot-lab-btn.active{border-color:#818cf8;background:var(--v2-secondary-subtle);color:#312e81;box-shadow:0 2px 8px rgba(99,102,241,.12);font-weight:750;}
    .plot-lab-panel{background:var(--v2-bg-elevated);border:1px solid var(--v2-border);border-radius:12px;padding:16px;min-height:230px;box-shadow:0 2px 8px rgba(15,23,42,.035);}
    .plot-lab-kicker{display:inline-block;padding:4px 9px;border-radius:999px;background:var(--v2-secondary-subtle);color:#3730a3;font-size:12px;font-weight:750;margin-bottom:10px;}
    .plot-lab-title{font-size:18px;font-weight:800;margin:0 0 8px;color:var(--v2-fg);}
    .plot-lab-desc{font-size:13.5px;line-height:1.75;color:var(--v2-fg-muted);margin:0 0 12px;}
    .plot-lab-code{background:var(--v2-fg);color:var(--v2-border);border-radius:10px;padding:11px 12px;font-size:12px;line-height:1.55;white-space:pre-wrap;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow:auto;}
    .plot-lab-hint{margin-top:10px;padding:9px 11px;background:var(--v2-bg-elevated);border:1px dashed var(--v2-border);border-radius:9px;color:var(--v2-fg-muted);font-size:12.5px;line-height:1.6;}
    .plot-preview{height:120px;margin:6px 0 12px;background:linear-gradient(180deg,var(--v2-bg-elevated),var(--v2-bg-elevated));border:1px solid var(--v2-border);border-radius:10px;position:relative;overflow:hidden;}
    ...
    .plot-check-item{border:1px solid var(--v2-border);border-radius:12px;background:var(--v2-bg-elevated);padding:12px;transition:all .15s;}
    .plot-check-item:hover{background:var(--v2-bg-elevated);}
    .plot-check-title{display:flex;align-items:center;gap:7px;font-weight:750;color:var(--v2-fg);font-size:14px;margin-bottom:5px;}
    .plot-check-desc{font-size:12.5px;color:var(--v2-fg-muted);line-height:1.6;margin:0;}
    .plot-progress{height:8px;background:var(--v2-border);border-radius:999px;overflow:hidden;margin:4px 0 12px;}
